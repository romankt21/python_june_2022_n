...
# #tuple кортеж - це список констант, яких не можна змінювати, записуються в круглих дужках. Не можна ні додавати, ні віднімати, можна підрахувати і витягнути елемент, знайти індекс елементу. Можна тільки витягнути з api
...
#
# c = {'name': 'max', 'age' : 15} # якщо ключ name текстового формату його теж потрібно брати в лапки, ключем виступає стрічка або кортеж
...
# setdefault_value = user.setdefault('key', 'value_my_key') # дозволяє додавати ключ якого немає і за бажанням значення. додає ключ, якщо такого немає, якщо ключ є він його не додає.
# print(setdefault_value) # повертає значення value_my_key
# print(user) # {'name': 'Max', 'age': 15, 'gender': 'male', 'key': 'value_my_key'}


# setdefault_value = user.setdefault('age', 'value_my_key') # якщо хочемо замінити значення в наявному ключі, то це значення не змігиться і залишиться попереднє значення
...
# l = [1, 2, 3, 4, 6, 2, 5, 4]
#
# s = set(l) # передаємо в змінну s свій список, який тепер буде set, при цьому всі дублікати в списку видаляються і залишаються тільки унікальні значення (без повторів)
#
# print(s)  # {1, 2, 3, 4, 5, 6}
...
# print(set1.issuperset(set2))       #  чи є в set1 всі елементи які є в set2  # False  # оскільки в set1 є 3, 4, 5, але немає 8 і 10
#
# set3 = {1, 2 , 3}
# print(set1.issuperset(set3))       #  чи є в set1 всі елементи які є в set3  # True  # оскільки в set1 є 1, 2, 3
#
# print(set1.isdisjoint(set2))        # перевіряє чи в set1 та в set2 немає спільних елементів, тоді True, якщо спільні елементи є тоді  False
#
# print(set1.intersection(set2))      # повертає спільні елементи, які є між двома set отримується новий set # {3, 4, 5}
# print(set1.difference(set2))        # # повертає відмінні елементи, які є в set1 і немає в set2 отримується новий set # {1, 2, 6}
#
...
#       # string стрінга, стрічка, пишуться в "str" або в 'str'
# string1 = "text"
# string2 = 'text'
